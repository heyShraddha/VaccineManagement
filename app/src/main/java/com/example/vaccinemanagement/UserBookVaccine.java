...
public class UserBookVaccine extends AppCompatActivity {
    ...
    submit_b.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if ((s1.equalsIgnoreCase("")) || (s2.equalsIgnoreCase("")) || (s3.equalsIgnoreCase("")) || (s4.equalsIgnoreCase(""))) {
                Toast.makeText(UserBookVaccine.this, "Please enter the field which is empty! ", Toast.LENGTH_SHORT).show();
            } else {
                ...
                Toast.makeText(UserBookVaccine.this, " " + ed_name.getText().toString() + "  got registered", Toast.LENGTH_SHORT).show();
                Intent myIntent = new Intent(UserBookVaccine.this, Home.class);
